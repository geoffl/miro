...
class GtkVideoWidget(gtk.DrawingArea):
    ...
    def __init__(self, renderer):
        ...
        self.hwnd = embeddingwindow.create(self)
        embeddingwindow.set_motion_events(self.hwnd, True)
        # pass it to our renderer
        self.renderer.set_window_id(self.hwnd)
    ...
    def do_realize(self):
        ...
        embeddingwindow.attach(self.hwnd, self.window.handle,
                *self._get_window_area())

    def do_unrealize(self):
        # detach our embedded window
        embeddingwindow.detach(self.hwnd)
        # call base class
    ...
    def do_configure_event(self, event):
        ...
        if self.flags() & gtk.REALIZED:
            ...
            embeddingwindow.reposition(self.hwnd, *self._get_window_area())
    ...
    def on_paint(self):
        if self.renderer.ready_for_expose():
            ...
            embeddingwindow.paint_black(self.hwnd)
    ...
    def destroy(self):
        ...
        embeddingwindow.destroy(self.hwnd)
        self.hwnd = None
